...
from metric_plots_k_20 import read_metrics
...
metrics = read_metrics('results/k_100_metrics.csv')
fpr = metrics[3]
tpr = metrics[2]
...
plt.savefig('plots/ROC_Curve_k100.png', dpi=300, bbox_inches='tight')
plt.show()